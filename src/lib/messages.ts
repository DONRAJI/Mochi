...
export const messages = {
  ...
  empty: {
    fridge: "냉장고가 비어도 괜찮아요 — 밖에서 먹을 곳 볼까요?",
    meals: "오늘은 모찌가 메뉴를 고르는 중이에요.",
    /** '밖에서 먹기' 장소에 보여줄 음식이 아직 없을 때(음식 사전 적재 전 등). */
    outside: "이 곳의 메뉴는 모찌가 아직 모으는 중이에요.",
  },
  /**
  ...
  attribution: {
    ...
    combined:
      "레시피 데이터 출처 — 식품의약품안전처 조리식품의 레시피 DB, 만개의레시피(한국농수산식품유통공사 KADX 제공). 음식 칼로리 제안 — 식품의약품안전처 전국통합식품영양성분정보(공공데이터포털). 조리법 원문의 권리는 각 작성자와 제공기관에 있습니다.",
  },
